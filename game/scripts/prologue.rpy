...
label start:
    ...
    street_boss "Я держу паб.\n{w}Мне нужен человек, который не боится грязной и тяжёлой работы. {w}Который всегда на месте."
    ...
    street_boss "Но мне нужна твоя полная отдача. {w}Я предлагаю тебе вторую жизнь, но ты должен оправдать моё доверие."
